...
export const chatTranslations = {
  en: {
    ...
    phoneDisclaimer: "Your number is only used to save your conversation securely.",

    // PIN view
    createPin: 'Create Your PIN',
    createPinSubtitle: 'Choose a 4-digit PIN to secure your conversations.',
    enterPin: 'Welcome Back! 🔐',
    enterPinSubtitle: 'Enter your 4-digit PIN for',
    ...
    phoneRegistered: 'This number is already registered. Please login instead.',
    phoneNotFound: 'Phone number not found. Please register first.',
    verifying: 'Verifying...',
  ...
  fr: {
    ...
    phoneDisclaimer: "Ton numéro sert uniquement à sauvegarder tes conversations en toute sécurité.",

    // PIN view
    createPin: 'Crée ton code PIN',
    createPinSubtitle: 'Choisis un code PIN à 4 chiffres pour sécuriser tes conversations.',
    enterPin: 'Bon retour ! 🔐',
    enterPinSubtitle: 'Entre ton code PIN à 4 chiffres pour',
    confirmPin: 'Confirme ton code PIN',
    pinLabel: 'Code PIN à 4 chiffres',
    pinMismatch: 'Les codes PIN ne correspondent pas. Réessaie.',
    startChatBtn: 'Commencer à discuter 💛',
    loginBtn: 'Se connecter 💛',
    setupPin: 'Configure ton code PIN',
    setupPinSubtitle: 'Crée un code PIN à 4 chiffres pour sécuriser ton compte.',
    invalidPin: 'Code PIN incorrect. Réessaie.',
    phoneRegistered: 'Ce numéro est déjà enregistré. Connecte-toi.',
    phoneNotFound: 'Numéro de téléphone introuvable. Inscris-toi d\'abord.',
