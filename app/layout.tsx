...
export const metadata: Metadata = {
  ...
  title: 'Dada Bora AI - The Big Sister You Wish You Had | AI Wellness for Women',
  description: 'Dada Bora AI is your 24/7 AI-powered wellness companion for every woman. Get culturally grounded support for mental health, beauty care, menstrual cycle tracking, and holistic wellness through WhatsApp. Available in English and French.',
  keywords: [
    'Dada Bora',
    'Dada Bora AI',
    'AI wellness for women',
    'women mental health',
    'wellness app for women',
    'AI therapy for women',
    'culturally competent mental health',
    'women self-care',
    'WhatsApp wellness bot',
    'AI companion for women',
    'mental wellness women',
  ...
  openGraph: {
    ...
    title: 'Dada Bora AI - Your AI Wellness Companion for Every Woman',
    description: 'Get 24/7 culturally grounded wellness support for mental health, beauty care, and holistic guidance. Built by African founders for women everywhere. Chat now on WhatsApp.',
    images: [
      {
        url: '/dada bora.PNG',
        width: 1200,
        height: 630,
        alt: 'Dada Bora AI - AI Wellness Companion for Every Woman',
      }
    ],
  },
  twitter: {
    ...
    description: '24/7 AI wellness support for every woman. Mental health, beauty care, cycle tracking & more via WhatsApp.',
...
export default function RootLayout({
  ...
  const structuredData = {
    ...
    '@type': 'WebApplication',
    name: 'Dada Bora AI',
    description: 'AI-powered wellness companion for women providing 24/7 support for mental health, beauty care, and holistic guidance',
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <link rel="icon" href="/dada-bora.png" type="image/png" />
